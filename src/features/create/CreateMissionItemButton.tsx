      ...
      {activePanel ? (
        ...
        >
          <div className="relative flex max-h-[92vh] w-full flex-col overflow-hidden rounded-t-[2rem] bg-white shadow-2xl ring-1 ring-slate-200 sm:mx-auto sm:max-w-3xl sm:rounded-[2rem]">
            ...
            {activePanel === 'task' ? (
              <footer className="shrink-0 flex items-center justify-between gap-2 border-t border-slate-100 bg-white px-4 py-3">
                {/* Left: cancel + reset */}
                ...
                <div className="flex items-center gap-2">
                  <button
                    type="button"
                    className="rounded-2xl bg-white px-4 py-2.5 text-sm font-black text-slate-700 ring-1 ring-slate-200 hover:bg-slate-50 transition disabled:opacity-40"
                  ...
                  <button
                    type="button"
                    className="rounded-2xl bg-slate-950 px-5 py-2.5 text-sm font-black text-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md disabled:opacity-40"
                    onClick={primarySave}
                    disabled={isSaving}
                  >
